fertilizer_dict = {
        'NHigh': """<b style = "color:#42855B;font-size:30px;">The N value of soil is high and might give rise to weeds.</b>
        <br/><br/>
        ...
        <p align="justify">5. <i>Use mulch (wet grass) while growing crops</i> - Mulch can also include sawdust and scrap soft woods </p>
        </div>""",

        'Nlow': """<b style = "color:#42855B;font-size:30px;">The N value of your soil is low.</b>
        <br/><br/> 
        <div style="font-size:20px;line-height:2">
        ...
        <p align="justify">8. <i>Do nothing</i> – It may seem counter-intuitive, but if you already have plants that are producing lots of foliage, it may be best to let them continue to absorb all the nitrogen to amend the soil for your next crops.</p>
        </div>""",
         
        'NNo': """<b style = "color:#42855B;font-size:30px;">The N value of your soil is up to the mark</b>.<hr style = "height:2px; background-color:#c79c60;">""",

        'PHigh': """<b style = "color:#42855B;font-size:30px;">The P value of your soil is high.</b>
        <br/> <br/>
        <div style="font-size:20px;line-height:2">
        ...
        <p align="justify">5. Use crop rotations to decrease high phosphorous levels</p>
        </div>""",

        'Plow': """<b style = "color:#42855B;font-size:30px;">The P value of your soil is low.</b>
        <br/> <br/>
        <div style="font-size:20px;line-height:2">
        ...
        <p align="justify">9. If pH is high, addition of appreciable amount of organic matter will help acidify the soil. Application of acidifying fertilizers, such as ammonium sulfate, can help lower soil pH</p>
        </div>""",

        'PNo': """<b style = "color:#42855B;font-size:30px;">The P value of your soil is up to the mark.</b>""",

        'KHigh': """<b style = "color:#42855B;font-size:30px;">The K value of your soil is high</b>.
        <br/> <br/>
        <div style="font-size:20px;line-height:2">
        ...
        'Klow': """<b style = "color:#42855B;font-size:30px;">The K value of your soil is low.</b>
        <br/><br/>
        <div style="font-size:20px;line-height:2">
        ...
        <p align="justify">5. Use Potash fertilizers since they contain high values potassium</p>
        </div>""",

        'KNo': """<b style = "color:#42855B;font-size:30px;">The K value of your soil is up to the mark.</b>"""
}